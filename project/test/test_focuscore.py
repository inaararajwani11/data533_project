...
from analytics.focuscore import compute_focus_score, focus_grade, compute_weekly_focus_score, compute_weekly_focus_with_grade
...
class TestFocusCore(unittest.TestCase):
    ...
    def test_compute_focus_score_basic_cases(self):
        ...
        score1 = compute_focus_score(
            total_focus_minutes=300,  # Maximum
            distraction_rate=0.0,     # Perfect (no distractions)
            habit_completion_rate=1.0 # Perfect completion
        )
        
        # Test case 2: Minimum score scenario  
        score2 = compute_focus_score(
            total_focus_minutes=0,    # No focus time
            distraction_rate=6.0,     # Maximum distractions
            habit_completion_rate=0.0 # No habits completed
        )
        
        # Test case 3: Average scenario
        score3 = compute_focus_score(
            total_focus_minutes=150,  # Half of maximum
            distraction_rate=3.0,     # Half of maximum distractions
            habit_completion_rate=0.5 # Half of habits completed
        )
        
        # Test case 4: No distraction data scenario
        score4 = compute_focus_score(
            total_focus_minutes=200,
            distraction_rate=None,    # No distraction data
    ...
    def test_focus_grade_classification(self):
        ...
        grade6 = focus_grade(59.9)  # Should be OK (40-60 range)
        grade7 = focus_grade(50.0)  # Should be OK (40-60 range)
        grade8 = focus_grade(40.0)  # Should be OK (40-60 range)
